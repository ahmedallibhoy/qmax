...
class ScaleSquareExponentiator(AbstractExponentiator):
    ...
    """
    m: int = eqx.field(static=True, default=55)
    # Backward-error target. None follows the active dtype's unit roundoff, which
    # is what the scheme was originally written for. Loosening it is the cheapest
